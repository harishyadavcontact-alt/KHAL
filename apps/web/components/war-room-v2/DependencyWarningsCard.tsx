...
function fieldLabel(field: string) {
  const labels: Record<string, string> = {
    ...
    risks: "write risks",
    odds: "write odds",
    odds_band: "set odds band",
    repeat_rate: "write repeat rate",
    survival_impact: "set survival impact",
    ...
    doctrine_chain: "link the selected craft to a doctrine chain",
    scenario_logic: "add scenario framing for the selected craft",
    threat_logic: "map threats inside the selected scenarios",
    response_logic: "define responses to the mapped threats",
