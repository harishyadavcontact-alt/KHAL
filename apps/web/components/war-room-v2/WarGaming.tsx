...
export const WarGaming = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {mode === "mission" && <WarGameMission missionId={modeTargetId} missionGraph={missionGraph} affairs={affairs} interests={interests} sources={sources} responseLogic={responseLogic} />}
