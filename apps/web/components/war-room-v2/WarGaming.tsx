  ...
  const currentFilledFieldKeys = useMemo(() => {
    if (mode === "source") {
      ...
      return [
        ...
        hasProfileCoverage && mappedProfiles.every((profile) => profile?.oddsText?.trim()) ? "odds" : null,
        hasProfileCoverage && mappedProfiles.every((profile) => profile?.oddsBand) ? "odds_band" : null,
        hasProfileCoverage && mappedProfiles.every((profile) => profile?.repeatRateText?.trim()) ? "repeat_rate" : null,
        hasProfileCoverage && mappedProfiles.every((profile) => profile?.survivalImpact) ? "survival_impact" : null,
