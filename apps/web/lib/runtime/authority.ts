...
export const RUNTIME_OWNERSHIP: RuntimeOwnershipEntry[] = [
  ...
  { entity: "portfolio war room", writeAuthority: "apps/web/lib/portfolio/store.ts", readAuthority: "canonical_sqlite", notes: "Portfolio command surfaces are local-first SQLite entities with optional interest links." },
