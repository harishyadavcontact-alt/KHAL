  ...
  interests: [
    {
      ...
      convexity: 9,
      labStage: "WIELD",
      hypothesis: "Tooling leverage compounds decision speed.",
      maxLossPct: 15,
      expiryDate: isoOffset(21 * day),
      killCriteria: ["No measurable cycle-time reduction by expiry"],
      hedgePct: 80,
      edgePct: 20,
      irreversibility: 25,
      status: "in_progress",
    ...
    },
    {
      ...
      convexity: 8,
      labStage: "FORGE",
      hypothesis: "Barbell split improves survivability and upside capture.",
      maxLossPct: 20,
      expiryDate: isoOffset(30 * day),
      killCriteria: ["Drawdown exceeds budget"],
      hedgePct: 90,
      edgePct: 10,
      irreversibility: 40,
      status: "not_started",
    ...
    },
    {
      ...
      convexity: 7,
      labStage: "TINKER",
      hypothesis: "Acute stress exposure lifts recovery capacity.",
      maxLossPct: 10,
      expiryDate: isoOffset(14 * day),
      killCriteria: ["Sleep quality drops for 3 consecutive days"],
      hedgePct: 85,
      edgePct: 15,
      irreversibility: 20,
      evidenceNote: "Week 1 showed better focus with fixed sleep window.",
      status: "in_progress",
    ...
    },
    {
      ...
      convexity: 8,
      labStage: "FORGE",
      hypothesis: "A smaller trusted network has higher optionality density.",
      maxLossPct: 25,
      expiryDate: isoOffset(-2 * day),
      killCriteria: ["No strategic reply in 4 weeks"],
      hedgePct: 70,
      edgePct: 30,
      irreversibility: 35,
      status: "not_started",
